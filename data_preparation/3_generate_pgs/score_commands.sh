...
# FEV1/FVC
mkdir -p data/scores/EFO_0004713/
python3 data_preparation/score.py --genotype_dir "data/ukbb_qc_genotypes/" --pgs-dir "data/pgs_weights/EFO_0004713/GRCh37/" --output-file "data/scores/EFO_0004713/ukbb.csv.gz"
python3 data_preparation/score.py --genotype_dir "data/ukbb_qc_cartagene/" --pgs-dir "data/pgs_weights/EFO_0004713/GRCh38/" --output-file "data/scores/EFO_0004713/cartagene.csv.gz"

# Height
mkdir -p data/scores/HEIGHT/
python3 data_preparation/score.py --genotype_dir "../cluster_analysis_alex/data/ukbb_qc_genotypes/" --pgs-dir "data/pgs_weights/HEIGHT/GRCh37/" --output-file "data/scores/HEIGHT/ukbb.csv.gz"
python3 data_preparation/score.py --genotype_dir "../../cartagene/research/prs_analysis/data/imputed_genotypes_BED/" --pgs-dir "data/pgs_weights/HEIGHT/GRCh38/" --output-file "data/scores/HEIGHT/cartagene.csv.gz"

# BMI
mkdir -p data/scores/EFO_0004340/
...
# LDL
mkdir -p data/scores/EFO_0004611/
...
# HDL
mkdir -p data/scores/EFO_0004612/
...
# T2D
mkdir -p data/scores/MONDO_0005148/
...
# Asthma
mkdir -p data/scores/MONDO_0004979/
...
# Testosterone
mkdir -p data/scores/EFO_0004908/
...
# Creatinine
mkdir -p data/scores/EFO_0004518/
...
# Urate
mkdir -p data/scores/EFO_0004531/
